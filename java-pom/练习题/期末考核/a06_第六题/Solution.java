...
public class Solution {
    public static void main(String[] args) {
        ...
        // ，然后对新链表遍历输出
        MyLinkedList<Integer> res = list1.merge(list2, Comparator.comparingInt(o -> o));
        print(res.head);

    }
    public static void print(MyLinkedList.Node<Integer> head){
        MyLinkedList.Node<Integer> node = head;
