...
public class TestXXX {
    ...
    void test01() {
        ...
        Assertions.assertTrue(origin.before(current));
    ...
    void test02() {
        ...
        Assertions.assertEquals(11, Calendar.DECEMBER);
        // 星期范围 1-7
        Assertions.assertEquals(1, Calendar.SUNDAY);
        Assertions.assertEquals(7, Calendar.SATURDAY);
    }
    ...
    void test03() {
        ...
        // Assertions.assertEquals("Thu Jan 01 08:00:01 CST 1970", calendar.getTime());
        ...
        Assertions.assertEquals(8, calendar.get(Calendar.MONTH));
        Assertions.assertEquals(10, calendar.get(Calendar.DAY_OF_MONTH));
        Assertions.assertEquals(1, calendar.get(Calendar.DAY_OF_WEEK));

        // public void add(int field, int amount) 为某个字段增加/减少指定的值
        calendar.add(Calendar.MONTH, -1);
        Assertions.assertEquals(7, calendar.get(Calendar.MONTH));
    }
