...
//获取空参，并创建对象
  ...
  //3.利用空参构造方法创建对象
  day36_05_注解.Student stu = (day36_05_注解.Student) con.newInstance();
...
public class ReflectDemo5 {
  public static void main(String[] args) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
    day36_05_注解.Student s = new day36_05_注解.Student("zhangsan", 23, "广州");
    day36_05_注解.Student ss = new day36_05_注解.Student("lisi", 24, "北京");
